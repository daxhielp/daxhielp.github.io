...
const projects = [
  {
    ...
    description: "Algorithmic trading system applying arbitrage pricing theory to detect risk-free profit opportunities by analyzing bid-ask spreads and price violations across correlated market outcomes.",
    tags: ["Python", "API handling", "Market Analysis"],
  ...
  },
  {
    ...
    description: "An ML-powered model that scans a news article and analyzes text structure to determine if it is fake. Deployed with React and FastAPI.",

...
const projects = [
  ...
  },
  {
    ...
    year: "2023",
    description: "Implemented an evolutionary algorithm using the NEAT (NeuroEvolution of Augmenting Topologies) framework to train a neural network to play Flappy Bird autonomously.",
